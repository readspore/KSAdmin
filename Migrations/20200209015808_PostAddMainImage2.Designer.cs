...
namespace KSAdmin.Migrations
{
    ...
    [Migration("20200209015808_PostAddMainImage2")]
    partial class PostAddMainImage2
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("KSAdmin.Areas.Admin.Models.Category", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KSAdmin.Areas.Admin.Models.FileModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int")
            ...
            modelBuilder.Entity("KSAdmin.Models.User", b =>
                {
            ...
            modelBuilder.Entity("KSAdmin.Areas.Admin.Models.PostCategory", b =>
                {
                    b.HasOne("KSAdmin.Areas.Admin.Models.Category", "Category")
                        .WithMany("PostCategorys")
                        .HasForeignKey("CategoryId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("KSAdmin.Areas.Admin.Models.Post", "Post")
                        .WithMany("PostCategorys")
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("KSAdmin.Models.User", null)
                        .WithMany()
